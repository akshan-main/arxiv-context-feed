...
def load_config(config_dir: Path | None = None) -> AppConfig:
    ...
    return AppConfig(
        ...
        contextual_api_key=os.getenv("CONTEXTUAL_API_KEY", "").strip(),
        contextual_datastore_id=os.getenv("CONTEXTUAL_DATASTORE_ID", "").strip(),
        contextual_base_url=os.getenv("CONTEXTUAL_BASE_URL", "https://api.contextual.ai").strip(),
